...
class PatientDiagnosisReport extends StatefulWidget {
  PatientDiagnosisReport({Key? key ,this.patient_id}) : super(key: key);
  final patient_id;
  @override
  State<PatientDiagnosisReport> createState() => _PatientDiagnosisReportState();
}

class _PatientDiagnosisReportState extends State<PatientDiagnosisReport> {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Your Diagnosis',style: TextStyle(
                      fontSize: 28,
