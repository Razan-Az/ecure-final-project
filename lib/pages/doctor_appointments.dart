...
class DoctorAppointments extends StatefulWidget {
  const DoctorAppointments({Key? key, this.doctor_id}) : super(key: key);
  final doctor_id;
...
class _DoctorAppointmentsState extends State<DoctorAppointments> {
  ...
  getStatusText(status,DateTime date,String time_slot){
    ...
    print("now"+DateTime.now().toLocal().toString()
                    ...
                    return InkWell(
                      onTap: (){
                        Navigator.of(context)
                            .push(MaterialPageRoute(builder: (context) => DoctorAppointmentsDetails(appointment_id: appointment.id,doctor_id: widget.doctor_id),));
                      },
                      child: ListTile(
                          leading: Column(
                        ...
                        title: Text(appointment["name"],style: const TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
