...
class DoctorCompleteProfile extends StatefulWidget {
    DoctorCompleteProfile({Key? key, this.user_id, this.user_name}) : super(key: key);
  final user_id;
  final user_name;

  @override
  State<DoctorCompleteProfile> createState() => _PatientCompleteProfilePageState();
}

class _PatientCompleteProfilePageState extends State<DoctorCompleteProfile> {
      ...
      body: Form(
        ...
        child: ListView(
          children: [
            ...
            const Center(
              child: Text("Upload a photo for patient to easily identify you"),
            ),
                  ...
                  if(_key.currentState!.validate())
                  {
                    ...
                    _firestore.collection("Users")
                      ...
                      "complete_profile":true
                        ...
                        .then((value){
                          Navigator.of(context).pop();
                       Navigator.of(context).push(MaterialPageRoute(builder: (context)=>DoctorHomePage( doctor_id: widget.user_id.toLowerCase(), doctor_name:widget.user_name,)));
                    }).catchError((e){
                      setState(() {
                        _isLoading=false;
                        _isError=true;
